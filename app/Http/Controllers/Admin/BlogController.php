...
class BlogController extends Controller
{
    ...
    public function master_blog_edit(Blog $blog)
    {
    ...
    public function master_blog_update(Request $request, Blog $blog)
    {
        $request->validate([
            'title'    => 'required',
            'category' => 'required',
    ...
    public function master_blog_delete(Blog $blog)
    {
        if ($blog->image && $blog->additional_image) {
            $key = json_decode($blog->additional_image);
