      ...
      <div class="app-page-title">
        <div class="page-title-wrapper">
          <div class="page-title-heading">
            ...
            <div>{{$merchant[0]->name}}<div class="page-title-subheading">Halo, <b>{{Auth()->user()->f_name}} {{Auth()->user()->l_name}}</b> anda terdaftar menggunakan email {{Auth()->user()->email}}</div></div>
          </div>
