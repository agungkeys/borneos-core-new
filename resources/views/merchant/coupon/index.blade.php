                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="m-auto align-middle" for="statusCheckbox{{$coupon->id}}">
                                            <input type="checkbox" data-toggle="toggle" data-size="small" onChange="location.href='{{route('merchant.master-coupon.status',[$coupon['id'],$coupon->status ? 0 : 1])}}'" id="statusCheckbox{{$coupon->id}}" {{$coupon->status ? 'checked' : ''}}>
                                        </label>
                                    </td>
                                    <td>
                                         <a href="{{ route('merchant.master-coupon.edit',$coupon->id) }}" class="btn btn-warning btn-sm"><i style="font-size: 14px" class="text-white pe-7s-note"></i></a>
