<div class="scrollbar-sidebar">
    <div class="app-sidebar__inner">
        <ul class="vertical-nav-menu">
            ...
            <li><a href="{{ route('admin.master-category') }}"><i class="metismenu-icon pe-7s-graph"></i>Master Category </a></li>
            <li><a href="#"><i class="metismenu-icon pe-7s-way"></i>Sub Category </a></li>
