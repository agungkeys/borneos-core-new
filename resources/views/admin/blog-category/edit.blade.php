   ...
   <div class="row">
      <div class="col-md-6">
         <div class="main-card mb-3 card">
            <div class="card-body">
               <form action="{{ route('admin.blog-category.update',$category) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                  @method('PUT')
                  @csrf
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" id="category_slug" name="category_slug" value="{{ $category->slug }}" class="form-control">
                     @error('category_slug')
                        <span class="text-danger mt-2">{{ $message }}</span>
                     @enderror
                  </div>
                  ...
                  <div class="form-group text-center" style="margin-bottom:0%;">
                     <img style="width: 25%;border: 0px solid; border-radius: 10px;" id="viewer" src="{{ URL::to($category->image) }}" alt=""/>
                  </div>
