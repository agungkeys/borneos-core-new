        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>List Courier <span
                            class="badge badge-pill badge-primary">{{ number_format($couriers->total(), 0, '', '.') }}</span>
                    </div>
                </div>
                            ...
                            <form class="form-inline" method="GET">
                                <div class="input-group">
                                    ...
                                    <input id="filter" name="filter" value="{{ $filter }}"
                                        placeholder="Search by Name, Phone and Address" type="text" class="form-control"
                                        style="color: gray;">
                                    <div class="input-group-prepend">
                ...
                <div class="table-responsive">
                            ...
                            @foreach ($couriers as $courier)
                                <tr>
                                    ...
                                    <td>
                                        <label class="m-auto align-middle" for="statusCheckbox{{ $courier->id }}">
                                            <input type="checkbox" data-toggle="toggle" data-size="small"
                                                onChange="location.href='{{ route('admin.courier.status', [$courier['id'], $courier->status ? 0 : 1]) }}'"
                                                id="statusCheckbox{{ $courier->id }}"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" onclick="delete_courier({{ $courier->id }})"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 w-100 d-flex justify-content-end align-middle">
                            <p>Displaying {{ $couriers->count() }} of {{ number_format($couriers->total(), 0, '', '.') }}
                                courier(s).</p>
                        </div>
                    </div>
                </div>
