                ...
                <div class="h-100 no-gutters row">
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h4 class="mb-0"><span class="d-block">Hi Selamat Datang Admin,</span><span>Silahkan masuk ke
                                    akun admin anda</span></h4>
                            ...
                            <div>
                                <form method="POST" id="form" action="{{ route('admin.auth.login') }}">
                                    ...
                                    <div class="position-relative form-check">
                                        ...
                                        <label class="form-check-label" for="remember" class="form-check-label">Keep me
                                            logged in</label>
                                    </div>
                                    <div class="divider row"></div>
                                    <div class="d-flex align-items-center">
                                        <div class="ml-auto">
                                            <button id="buttonSubmit" class="btn btn-primary btn-lg" type="submit">Login
                                                Admin</button>
                                        </div>
                                    </div>
                                </form>
