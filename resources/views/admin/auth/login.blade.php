            ...
            <div class="slick-slider">
              <div>
                <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                  {{-- <div class="slide-img-bg" style="background-image: url('{{ asset(env('PUBLIC_ASSETS').'images/originals/city.jpg') }}');"></div> --}}
                   <div class="slide-img-bg"><img src="{{ URL::to('https://res.cloudinary.com/borneos-co/image/upload/w_455,h_650,c_fill/v1662340637/images/login/admin/1_ezoh16.webp') }}" alt=""></div>
              ...
              <div>
                <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                  ...
                  <div class="slide-img-bg"><img src="{{ URL::to('https://res.cloudinary.com/borneos-co/image/upload/w_455,h_650,c_fill/v1662340637/images/login/admin/3_wwatxs.webp') }}" alt=""></div>
                  <div class="slider-content">
              ...
              <div>
                <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                  ...
                  <div class="slide-img-bg"><img src="{{ URL::to('https://res.cloudinary.com/borneos-co/image/upload/w_455,h_650,c_fill/v1662340636/images/login/admin/2_sfp1vt.webp') }}" alt=""></div>
                  <div class="slider-content">
